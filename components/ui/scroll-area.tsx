    ...
    <>
      <div
        ...
        className={cn(
          ...
          isCard ? "before:from-card" : "before:from-background",
          "before:bg-linear-to-b before:to-transparent",
          isCard ? "after:from-card" : "after:from-background",
      ...
      <div
        ...
        className={cn(
          ...
          isCard ? "after:from-card" : "after:from-background",
          "after:bg-linear-to-l after:to-transparent",
          className,
        )}
      />
    </>
